// Configuration constants for the Chaos kernel.
//
// All `pub const` values that govern sizes, addresses, syscall numbers, signal
// numbers, scheduling parameters, and other tunables live here.
...
// VM region protection / mapping flags.
...
// Syscall numbers (Linux x86_64 layout).
